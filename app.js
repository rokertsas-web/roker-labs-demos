...
function Topbar({ country, setCountry, services }) {
  return /* @__PURE__ */ React.createElement("header", { className: "topbar" }, /* @__PURE__ */ React.createElement("div", { className: "topbar-brand" }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), "ROKER ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--crimson-500)" } }, "LABS")), /* @__PURE__ */ React.createElement("nav", { className: "topbar-nav" }, /* @__PURE__ */ React.createElement("a", { href: "#demos" }, "Sistemas"), /* @__PURE__ */ React.createElement("a", { href: "#proceso" }, "C\xF3mo trabajo"), /* @__PURE__ */ React.createElement("a", { href: "#analisis" }, "An\xE1lisis gratis"), /* @__PURE__ */ React.createElement("a", { href: "#faq" }, "FAQ"), /* @__PURE__ */ React.createElement("a", { href: "#contacto" }, "Contacto")), /* @__PURE__ */ React.createElement("div", { className: "topbar-spacer" }), /* @__PURE__ */ React.createElement(QuickLaunch, null), /* @__PURE__ */ React.createElement(CountrySwitch, { country, setCountry }), /* @__PURE__ */ React.createElement(MagneticButton, { strength: 0.25 }, /* @__PURE__ */ React.createElement("a", { className: "btn btn--primary btn--pulse", href: "#contacto" }, "Agendar demo ", /* @__PURE__ */ React.createElement(TechIcon, { name: "arrow-right", size: 16 }))));
}
...
function Process({ waPrefill }) {
  const steps = [
    { n: "01", t: "Llamada de diagn\xF3stico", d: "25 minutos, gratis. Vemos tu operaci\xF3n, los cuellos de botella y si tiene sentido seguir." },
    { n: "02", t: "Propuesta en 48hs", d: "Precio fijo, sin letra chica. Un mock funcional con tus datos reales. Sin contrato todav\xEDa." },
    { n: "03", t: "Construcci\xF3n iterativa", d: "Primera versi\xF3n funcional en 30 d\xEDas. Updates semanales. El equipo empieza a usar mientras se construye." },
    { n: "04", t: "Lanzamiento y soporte", d: "WhatsApp directo. Bugs resueltos el mismo d\xEDa. Soporte incluido 60 d\xEDas post-lanzamiento." }
  ];
  return /* @__PURE__ */ React.createElement("section", { className: "section process-section", id: "proceso" }, /* @__PURE__ */ React.createElement("div", { className: "section-head" }, /* @__PURE__ */ React.createElement("div", { className: "section-eyebrow" }, "C\xF3mo trabajo"), /* @__PURE__ */ React.createElement("h2", { className: "section-h2" }, "Del diagn\xF3stico al sistema en producci\xF3n."), /* @__PURE__ */ React.createElement("p", { className: "section-sub" }, "Sin metodolog\xEDas inventadas. Sin reuniones de planning eternas. Cuatro pasos.")), /* @__PURE__ */ React.createElement("div", { className: "process-steps" }, steps.map((s) => /* @__PURE__ */ React.createElement("div", { key: s.n, className: "process-step" }, /* @__PURE__ */ React.createElement("div", { className: "process-step__num" }, s.n), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "process-step__title" }, s.t), /* @__PURE__ */ React.createElement("p", { className: "process-step__desc" }, s.d))))), /* @__PURE__ */ React.createElement("div", { className: "process-cta" }, /* @__PURE__ */ React.createElement(MagneticButton, { strength: 0.3 }, /* @__PURE__ */ React.createElement("a", { className: "btn btn--lg btn--primary btn--pulse", href: waPrefill("una llamada de diagn\xF3stico gratuita") }, "Agendar llamada gratuita ", /* @__PURE__ */ React.createElement(TechIcon, { name: "arrow-right", size: 18 }))), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "var(--fg-4)" } }, "25 min \xB7 sin compromiso \xB7 sin tarjeta")));
}
function FAQ() {
  const items = [
    {
      q: "\xBFTrabaj\xE1s solo? \xBFQu\xE9 pasa si me dej\xE1s colgado?",
      a: "15 a\xF1os trabajando as\xED, sin interrupciones mayores. Para urgencias cr\xEDticas tengo backup en la nube y acceso remoto desde cualquier dispositivo. El SLA real: en 3 a\xF1os de sistemas propios no hubo downtime mayor a 4 horas en horario laboral."
    },
    {
      q: "\xBFCu\xE1nto tarda implementar un sistema desde cero?",
      a: "30 d\xEDas para la primera versi\xF3n funcional. No el producto terminado \u2014 el n\xFAcleo operativo que el equipo empieza a usar. Las iteraciones siguientes salen en sprints de 7 a 10 d\xEDas."
    },
    {
      q: "\xBFQu\xE9 pasa si necesito cambios despu\xE9s del lanzamiento?",
      a: "Soporte incluido 60 d\xEDas post-lanzamiento. Bugs = mismo d\xEDa. Features nuevas = cotizaci\xF3n separada antes de empezar, sin sorpresas ni cambios de precio en el camino."
    },
    {
      q: "\xBFIntegr\xE1s con MercadoLibre, AFIP, WhatsApp?",
      a: "S\xED. ML (listings, \xF3rdenes, stock), AFIP/ARCA (SICORE, percepciones, facturaci\xF3n electr\xF3nica), SIFEN Paraguay, WhatsApp API. Cada integraci\xF3n se cotiza por separado seg\xFAn complejidad."
    },
    {
      q: "\xBFEl c\xF3digo queda m\xEDo si dejamos de trabajar?",
      a: "100%. Al cerrar el proyecto entrego el repositorio completo (GitHub privado a tu nombre) m\xE1s documentaci\xF3n t\xE9cnica. Sin lock-in: cualquier desarrollador puede continuar desde donde dejamos."
    },
    {
      q: "\xBFPuedo empezar con algo peque\xF1o sin compromiso?",
      a: "Ese es exactamente el modelo. La llamada de diagn\xF3stico es gratis. La propuesta t\xE9cnica viene con un mock con tus datos reales, sin contrato todav\xEDa. La mayor\xEDa empieza con un solo m\xF3dulo y escala cuando ve el resultado."
    }
  ];
  const [open, setOpen] = useState(null);
  const toggle = (i) => setOpen(open === i ? null : i);
  return /* @__PURE__ */ React.createElement("section", { className: "section faq-section", id: "faq" }, /* @__PURE__ */ React.createElement("div", { className: "section-head" }, /* @__PURE__ */ React.createElement("div", { className: "section-eyebrow" }, "Preguntas frecuentes"), /* @__PURE__ */ React.createElement("h2", { className: "section-h2" }, "Las dudas que frenan la decisi\xF3n."), /* @__PURE__ */ React.createElement("p", { className: "section-sub" }, "Respuestas directas, sin marketing.")), /* @__PURE__ */ React.createElement("div", { className: "faq-list" }, items.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: `faq-item${open === i ? " is-open" : ""}` }, /* @__PURE__ */ React.createElement("button", { className: "faq-q", onClick: () => toggle(i), "aria-expanded": open === i }, /* @__PURE__ */ React.createElement("span", null, item.q), /* @__PURE__ */ React.createElement("span", { className: "faq-chevron", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" }, /* @__PURE__ */ React.createElement("path", { d: "M4 6l4 4 4-4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })))), /* @__PURE__ */ React.createElement("div", { className: "faq-a", "aria-hidden": open !== i }, /* @__PURE__ */ React.createElement("div", { className: "faq-a-inner" }, item.a))))));
}
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Topbar, { country, setCountry: onSetCountry, services: data.services }), /* @__PURE__ */ React.createElement("main", { className: "page" }, /* @__PURE__ */ React.createElement(Hero, { data, country, waPrefill }), /* @__PURE__ */ React.createElement(TrustBar, { data, country }), /* @__PURE__ */ React.createElement(DemosShowcase, { data, country }), /* @__PURE__ */ React.createElement(Process, { waPrefill }), /* @__PURE__ */ React.createElement(LeadMagnet, { data, country }), /* @__PURE__ */ React.createElement(WaCta, { data, country, waPrefill }), /* @__PURE__ */ React.createElement(FAQ, null), /* @__PURE__ */ React.createElement(Footer, { data, country })));
}
